...
/**
 * Requerimiento 3.1: búsqueda por nombre + filtros + orden alfabético.
 * También atiende el criterio de aceptación 3.2 (clic en una etiqueta ->
 * lista de videojuegos vinculados) vía el parámetro etiquetaId.
 *
 * Ejemplos:
 *   /busqueda?nombre=zelda&genero=aventura&orden=DESC
 *   /busqueda?etiquetaId=4
 */
@WebServlet("/busqueda")
