...
/**
 * Requerimiento 1.1: registro de cuentas nuevas.
 * Todo el que se registra por este formulario queda con rol USUARIO;
 * Editor/Administrador se asignan aparte (no hay auto-registro con esos roles).
 */
@WebServlet("/registro")
