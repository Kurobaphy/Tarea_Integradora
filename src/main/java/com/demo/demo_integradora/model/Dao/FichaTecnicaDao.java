...
/**
 * DAO de FichaTecnica (Requerimiento 2.2).
 * Como "plataformas" es una lista, no cabe en una sola columna:
 * se guarda en una tabla auxiliar aparte.
 *
 * DDL de referencia:
 *
 * CREATE TABLE ficha_tecnica (
 *   id                   NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
 *   desarrollador        VARCHAR2(100),
 *   fecha_lanzamiento    DATE,
 *   genero               VARCHAR2(50),
 *   puntuacion_promedio  NUMBER(3,2) DEFAULT 0
 * );
 *
 * CREATE TABLE ficha_tecnica_plataformas (
 *   ficha_tecnica_id NUMBER NOT NULL REFERENCES ficha_tecnica(id),
 *   plataforma       VARCHAR2(50) NOT NULL,
 *   PRIMARY KEY (ficha_tecnica_id, plataforma)
 * );
 */
