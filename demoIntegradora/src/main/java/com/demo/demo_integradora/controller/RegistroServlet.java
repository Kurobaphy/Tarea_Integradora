...
public class RegistroServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String error = validar(nombreUsuario, correo, contrasena);
    ...
    private String validar(String nombreUsuario, String correo, String contrasena) {
        if (isBlank(nombreUsuario) || isBlank(correo) || isBlank(contrasena)) {
            return "Nombre de usuario, correo y contraseña son obligatorios.";
        }
