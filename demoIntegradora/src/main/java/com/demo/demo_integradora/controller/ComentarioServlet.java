...
/**
 * Requerimiento 4.1: publicar comentarios. Leerlos es público (se resuelve
 * en ArticuloServlet al mostrar el detalle); publicar exige sesión iniciada.
 */
...
public class ComentarioServlet extends HttpServlet {
    ...
    /**
     * Solo el propio autor del comentario o un Administrador (moderación)
     * pueden borrarlo. Es un chequeo de PROPIEDAD del recurso, no de rol,
     * así que ni AuthFilter ni RoleFilter lo pueden resolver — tiene que
     * validarse aquí, comparando el autor guardado contra quien pide borrar.
     */
